...
#### **排程執行記錄使用者篩選器**
- **位置**：在「排程執行記錄」頁面的右側篩選面板頂部
- **功能**：按使用者篩選執行記錄
- **使用方式**：
  - 點擊「使用者」下拉選單
  - 選擇要篩選的使用者
  - 頁面會自動刷新，只顯示該使用者的執行記錄
...
### 場景 4：查看特定用戶的執行記錄
1. 進入「排程執行記錄」頁面
2. 選擇「使用者」篩選器，選擇「osmunt」
3. 查看「osmunt」用戶的所有執行記錄
